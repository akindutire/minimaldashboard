...
<head>
  <meta charset="utf-8">
	...
	<!-- Bootstrap 4.0-->
	<link rel="stylesheet" href="<?php echo $absPathForRequest.'view/asset/vendor_components/bootstrap/dist/css/bootstrap.min.css'; ?>">
...
<body class="hold-transition bg-img" style='background-image: url(<?php echo $absPathForRequest.'view/asset/img/banner.jpg' ?>);' data-overlay="1">
			...
			<div class="col-12">
				<div class="row no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						...
						<div class="p-30 content-bottom rounded bg-img box-shadowed" style="background-image: url(<?php echo $absPathForRequest.'view/asset/img/bg.jpg'; ?>);" data-overlay="8">
						
							<p style="text-align: center; color: #e53935 ; font-size: 2em;"><?php echo Session::getSession('error'); ?></p>

							<form action="<?php echo $routerLink.'action/login'; ?>" method="post">
								<div class="form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text bg-transparent bt-0 bl-0 br-0 no-radius text-white"><i class="ti-user"></i></span>
										</div>
										<input type="text" class="form-control pl-15 bg-transparent bt-0 bl-0 br-0 text-white" name="username" placeholder="Username">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" class="form-control pl-15 bg-transparent bt-0 bl-0 br-0 text-white" name="password" placeholder="Password">
							...
							<!-- <div class="text-center">
								<p class="mt-15 mb-0 text-white">Don't have an account? <a href="<?php echo $routerLink.'register'; ?>" class="text-info ml-5">Sign Up</a></p>
							</div> -->
						</div>
					</div>
				</div>
