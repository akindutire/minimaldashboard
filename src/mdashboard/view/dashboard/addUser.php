			...
			<div class="col-12">
			  <div class="box">
				...
				<div class="box-body">
                    ...
                    <form action="<?php echo $routerLink.'action/adduser'; ?>" method="post">
                        <div class="form-group row">
                            <label class="col-form-label col-md-2">Fullname</label>
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="fname" maxlength="100" minlength="2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="address" maxlength="100" minlength="2">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="tel" name="phone" maxlength="16">
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="month" name="birthday" required>
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control" name="aboutme" style="resize: vertical;" maxlength="300"></textarea>
                                <span class="form-text text-muted"></span>
                            </div>
                        </div>
